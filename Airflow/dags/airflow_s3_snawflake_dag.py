...
with DAG('airflow_s3_to_snowflake_with_email_notification_etl',
    ...
    copy_sponsor_file_into_snowflake_table = SnowflakeOperator(
        ...
        snowflake_conn_id = 'conn_id_sponsor',
        sql = '''COPY INTO sponsor_database.new_sponsor_schema.sponsor 
        from @sponsor_database.new_sponsor_schema.snowflake_sponsor_stage FILE_FORMAT = csv_format
        '''
    )
    ...
    copy_medical_file_into_snowflake_table = SnowflakeOperator(
        ...
        snowflake_conn_id = 'conn_id_medical',
        sql = '''COPY INTO medical_database.new_medical_schema.medical_condition 
        from @medical_database.new_medical_schema.snowflake_medical_stage FILE_FORMAT = csv_format
        '''
    )
    ...
    copy_drug_file_into_snowflake_table = SnowflakeOperator(
        ...
        snowflake_conn_id = 'conn_id_medical',
        sql = '''COPY INTO drug_database.new_drug_schema.drug_product 
        from @drug_database.new_drug_schema.snowflake_drug_stage FILE_FORMAT = csv_format
        '''
    )
    ...
    copy_protocol_file_into_snowflake_table = SnowflakeOperator(
        ...
        snowflake_conn_id = 'conn_id_protocol',
        sql = '''COPY INTO protocol_database.new_protocol_schema.protocol 
        from @protocol_database.new_protocol_schema.snowflake_protocol_stage FILE_FORMAT = csv_format ON_ERROR = 'CONTINUE'
        '''
    )
    ...
    copy_trial_file_into_snowflake_table = SnowflakeOperator(
        ...
        snowflake_conn_id = 'conn_id_trial',
        sql = '''COPY INTO trial_database.new_trial_schema.trial_status 
        from @trial_database.new_trial_schema.snowflake_trial_stage FILE_FORMAT = csv_format
        '''
    )
    ...
    copy_study_file_into_snowflake_table = SnowflakeOperator(
        ...
        snowflake_conn_id = 'conn_id_study',
        sql = '''COPY INTO study_database.new_study_schema.study_population 
        from @study_database.new_study_schema.snowflake_study_stage FILE_FORMAT = csv_format
        '''
    )
